# RegistryControllerApi

All URIs are relative to *http://localhost:8080/rest*

| Method | HTTP request | Description |
|------------- | ------------- | -------------|
| [**getComponentItem**](RegistryControllerApi.md#getComponentItem) | **GET** /registry/components/{componentId}/description |  |
| [**getComponents**](RegistryControllerApi.md#getComponents) | **GET** /registry/components |  |
| [**getProfileItem**](RegistryControllerApi.md#getProfileItem) | **GET** /registry/profiles/{componentId}/description |  |
| [**getProfiles**](RegistryControllerApi.md#getProfiles) | **GET** /registry/profiles |  |
...
import eu.clarin.cmdi.componentregistry.openapi.client.api.RegistryControllerApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        RegistryControllerApi apiInstance = new RegistryControllerApi(defaultClient);
        ...
        try {
            ...
            System.err.println("Exception when calling RegistryControllerApi#getComponentItem");
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling RegistryControllerApi#getComponents");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling RegistryControllerApi#getProfileItem");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling RegistryControllerApi#getProfiles");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
