...
public class ComponentDescription {
  ...
  public ComponentDescription name(@jakarta.annotation.Nullable String name) {
  ...
  public ComponentDescription description(@jakarta.annotation.Nullable String description) {
  ...
  public ComponentDescription registrationDate(@jakarta.annotation.Nullable OffsetDateTime registrationDate) {
  ...
  public ComponentDescription creatorName(@jakarta.annotation.Nullable String creatorName) {
  ...
  public ComponentDescription userId(@jakarta.annotation.Nullable String userId) {
  ...
  public ComponentDescription domainName(@jakarta.annotation.Nullable String domainName) {
  ...
  public ComponentDescription href(@jakarta.annotation.Nullable String href) {
  ...
  public ComponentDescription groupName(@jakarta.annotation.Nullable String groupName) {
  ...
  public ComponentDescription status(@jakarta.annotation.Nullable StatusEnum status) {
  ...
  public ComponentDescription derivedfrom(@jakarta.annotation.Nullable String derivedfrom) {
  ...
  public ComponentDescription successor(@jakarta.annotation.Nullable String successor) {
  ...
  public ComponentDescription commentsCount(@jakarta.annotation.Nullable Integer commentsCount) {
  ...
  public ComponentDescription recommended(@jakarta.annotation.Nullable Boolean recommended) {
  ...
  public ComponentDescription _public(@jakarta.annotation.Nullable Boolean _public) {
  ...
  public ComponentDescription id(@jakarta.annotation.Nullable String id) {
  ...
  public ComponentDescription showInEditor(@jakarta.annotation.Nullable Boolean showInEditor) {
  ...
  public ComponentDescription isPublic(@jakarta.annotation.Nullable Boolean isPublic) {
